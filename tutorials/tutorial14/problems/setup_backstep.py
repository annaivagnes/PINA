"""
Data pipeline for the backward-facing step (Navier-Stokes) dataset.
...
class BackstepProblem:
    """
    Data pipeline for the backward-facing step dataset.
    ...
    def _load_data(self):
        """Load the Navier-Stokes dataset and extract snapshots, coordinates, parameters."""
